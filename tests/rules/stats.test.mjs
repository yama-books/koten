...
function fixture(official = false) {
  return {
    ...
    entryCounts: { quick: 7, view: 8, learn: 9, review: 10, exam: 11 },
...
test('E-13 count maps require exact keys', async () => { for (const key of ['buttonCounts','entryCounts','questionTypeCounts']) { const d=fixture(); delete d[key][Object.keys(d[key])[0]]; await assertFails(setDoc(ref('stats_days_test'),d)); const e=fixture(); e[key].extra=1; await assertFails(setDoc(ref('stats_days_test'),e)); } });
