...
export const TELEMETRY_FILES = ['aggregate.ts', 'client-number.ts', 'counters.ts', 'queue.ts', 'registry.ts', 'sanitize.ts'] as const;
...
export function payload(): StatsPayload {
  return {
    ...
    entryCounts: { quick: 5, view: 1, learn: 8, review: 2, exam: 0, author: 4 }, questionTypeCounts: { blank: 9, author: 6 },
