...
#### D1. 作品単位監査
現在地: **15 / 21作品 監査status確定（publicationReady 10 / partial 4 / blocked 1）、54 / 120例 公開接続済み**
...
5. 平家物語 16
6. 方丈記再訪
7. 十訓抄引用漢詩4例再訪（same-work witness方針）
8. 枕草子保留4例再訪（同一語形を保つ再利用可能版が得られた場合）
9. 更級日記保留1例再訪（同一箇所を含む再利用可能版が得られた場合）
10. 落窪物語再訪（検索可能な公開本文が得られた場合）
