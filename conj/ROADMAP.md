...
#### D1. 作品単位監査
現在地: **14 / 21作品 監査status確定（publicationReady 10 / partial 3 / blocked 1）、50 / 120例 公開接続済み**
...
6. 平家物語 16
7. 方丈記再訪
8. 十訓抄引用漢詩4例再訪（same-work witness方針）
9. 枕草子保留4例再訪（同一語形を保つ再利用可能版が得られた場合）
