...
| **A-25** | **破壊試験 C-0 〜 C-15 を 18 件すべて実施し、各回の出力を報告に貼った** | §5.1。**未実施が 1 件でもあれば不合格である**（発注039 で実際に起きた。§5.1 の前書きを読むこと） |
...
> **本発注は C-0 から C-15 まで 18 件ある（C-5 は C-5a・C-5b・C-5c の 3 件である。訂正 1）。1 件も省かないこと。**
...
5. **破壊試験 C-0 〜 C-15 の 18 件すべて**（C-5a・C-5b・C-5c を別に数える）。
