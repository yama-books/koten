...
## 記録UI円形カード化 / 狭幅QA（2026-09-20）

§46承認の記録UI変更を実装し、Web-only QAを完了。

### 実装
- 行タイル: 2列正方形を維持、行名・行リングを拡大。
- 行展開内: 旧横長習熟度バーを削除。
- 各字体: 正方形カード + 円形習熟度リング。
- 円中央: 大きい変体仮名 + 小さい字母。
- 円下: 習熟度%。
...
- %がリング外にある。
- meter値と%表示が一致。
- RC25の30%/65%出題切替、65/90 cap、日次+20、翌日+2を回帰維持。
...
### 未実施
iPhone Safariでの改修後実機目視。
特に3列/2列の密度、字形と字母の視覚階層、リング色の強さを確認する。
